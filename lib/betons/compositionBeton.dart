...
import 'typeStructure.dart';

class Beton extends StatefulWidget {
  @override
  _BetonState createState() => _BetonState();
}

//creation de chaque ligne cotenant un text et un Textfiel

class _BetonState extends State<Beton> {
          ...
          child: Container(
            ...
            child: Column(
              children: [
                ...
                Text("Dans une compostion 1 : 2 : 3 , pour 1 sac on a 2 sable  et 3 agregat (gravier).                              ")
              ],
            ),
          ),
        ),
